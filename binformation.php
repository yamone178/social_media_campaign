  ...
  <div class="page-container">
    <main>
      <section id="information">
        ...
        <div class="container justify-center align-center">
            <div class="first d-flex justify-center">
                <div class="inform-text">
                  <h2>Empowering Voices: Transforming Digital Connections Worldwide</h2>
                  <p>Welcome to Empowering Voices, where we believe in the power of social media to create meaningful change. Our platform is dedicated to crafting impactful and engaging campaigns that amplify voices, foster connections, and drive positive conversations. We are passionate about harnessing the potential of digital spaces to unite communities and inspire action.</p>

                  <a href="" class="btn btn-border">Read Our Missions</a>
        ...
        <div class="social-campaign">
           <div class="social-campaign-text">
              <h2>Teen Voices Unite: Inspiring Change Through Social Media</h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis nobis delectus expedita consectetur repellat inventore aliquam reiciendis error ex quas, vero obcaecati, architecto quia id quae, adipisci doloremque nisi perferendis!</p>
           </div>
        </div>

      <div class="section-divider"></div>

      <div class="container mission-vission align-center">
        <div class="col-2">
          <div class="container flex-wrap justify-evenly">
