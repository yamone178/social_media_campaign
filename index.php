      ...
      <section id="home">
        ...
        <div class="service-container">
          <div class="web-service">
            ...
            <p><a href="registration.php" class="btn-sm btn-dark mt-10 service-register">Register Now</a></p> 
          </div>
        ...
        <section class="popular-apps">
          ...
          <div class="container justify-between">
              <div class="app">
                  <img src="./images/instagram_2504918.png" width="60px" alt="">
                  <p>instagram</p>
              </div>

              <div class="app">
                  <img src="./images/facebook_2504903.png" width="60px" alt="">
                  <p>instagram</p>
              </div>

              <div class="app">
                  <img src="./images/whatsapp_2504957.png" width="60px" alt="">
                  <p>instagram</p>
              </div>
