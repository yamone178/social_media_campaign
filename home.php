...
<?php 
  ...
  include './textLimit.php'; // Ensure this path is correct

  use MyNamespace\LimitText;
  ...
  <body>
    ...
    <div class="page-container">
      <header class="divider-sm">
        <div class="hero-section">
            <div class="container justify-center align-center hero-container">
              <div class="col-2">
    ...
    <main>
      <section id="home">
        ...
        <?php if ($resServices->num_rows > 0) {
          
          while ($resService = $resServices->fetch_assoc()) { ?>
                <div class="web-service">
                <h3><?php echo $resService['title'] ?></h3>
                <p class=" mt-10">
                  <?php echo $resService['description'] ?>
                </p>
                <p class="mt-5">Date - <?php echo $resService['info'] ?></p>
        ...
        <section class="popular-apps">
          ...
          if ($resApps->num_rows > 0 ) {
              while ($resApp = $resApps->fetch_assoc()) { ?>
                
                <a href="<?php echo $resApp['privacylink'] ?>" class="app">
                  <img src="./images/<?php echo $resApp['logo'] ?>" width="60px" alt="">
                  <p>
                    <?php echo $resApp['name'] ?> <br>
        ...
        <section class="stay-safe-online">
          ...
          <div class="container align-center justify-center">
            ...
            <div class=" col-2">
                <h2 class="">How to Stay Safe Online</h2>
        ...
        <section id="newsletter">
            <?php if ($sub == 0) { ?>
              ...
              <?php if ($resNews->num_rows > 0) {
               
               while ($resNew = $resNews->fetch_assoc()) { ?>

                <div class="card">
                    <div class="img">
                        <img src="./images/<?php echo $resNew['image'] ?>" alt="">
                    </div>
                    <div class="content">
                      <h4><?php echo $resNew['title'] ?> </h4>
                      <p><?php echo LimitText::limit_text($resNew['content'], 150)  ?></p>
                      <p>Publish Date - <?php echo $resNew['publishdate'] ?></p>

                      <a href="readmore.php?showId=<?php echo $resNew['id']; ?>" class="btn btn-dark">Read More</a>
                    </div>
                </div>
            ...
            <?php  }else { ?>
              <form action="#" method="post" class="sub">
                  <label for="name"> Newsletter Subscription</label> <br>
                  <input type="radio" id="name" name="sub" value="1" required>Yes
                  <input type="radio" id="name" name="sub" value="0" required>No
                  <button type="submit" name="btnSub" class="btnSub btn btn-light">Subscribe</button>
